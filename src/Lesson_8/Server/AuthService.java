...
public class AuthService {
    ...
    public static void connect() throws SQLException {
        try {
            ...
            connection = DriverManager.getConnection("jdbc:sqlite:src/Lesson_8/clients.db");
    ...
    public static void addMsgToDatabase(String sender, String receiver, String text, String date){
    ...
    public static String getMessagesFromDatabase(String nick){
